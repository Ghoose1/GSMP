...
namespace GSMP
{
	public static class TileUtils
	{
		...
		public static bool TryGetTileEntityAs<SpellTileEntity>(int i, int j, out SpellTileEntity entity) where SpellTileEntity : TileEntity
		{
			...
			if (TileEntity.ByPosition.TryGetValue(origin, out TileEntity existing))
			{
				Main.NewText("B");
